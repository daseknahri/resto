      ...
      >
        <section class="ui-glass p-4 sm:p-5 space-y-4">
          ...
          <CartPromoCode
            ...
            :promo-open="promoOpen"
            :promo-code="promoCode"
            :promo-checking="promoChecking"
            :promo-error="promoError"
            @toggle-open="promoOpen = !promoOpen"
            @promo-code-input="onPromoCodeInput"
...
// CartPromoCode emits the raw typed value (it doesn't own promoCode); this
// mirrors the exact transform the original inline <input> handler used to do.
...
// ROAD_FACTOR / haversineKm / validCoord / AVG_SPEED_KMH are shared with the
// marketplace flow — see lib/deliveryPricing.js.
