    ...
    <div class="ui-auth-stage">
      <section class="ui-auth-spotlight relative space-y-6" aria-hidden="true">
        <div class="relative space-y-3">
          ...
          <h2 class="ui-display max-w-lg text-4xl font-semibold text-white">{{ t("activateAccount.title") }}</h2>
      ...
      <main>
        <div class="ui-auth-card ui-reveal space-y-6">
          <div class="ui-hero-ribbon space-y-2 text-center">
          ...
          <form class="space-y-4" novalidate @submit.prevent="submit">
            ...
            <p v-if="store.success" role="status" class="rounded-2xl border border-emerald-500/30 bg-emerald-500/10 px-4 py-3 text-sm text-emerald-200">{{ t("activateAccount.activated") }}</p>
          </form>
        </div>
      </main>
    </div>
