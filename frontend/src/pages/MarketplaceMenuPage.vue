  ...
  <div class="min-h-screen bg-slate-950 pb-32 ui-safe-bottom">
    ...
    <template v-else-if="restaurant">
      ...
      <MarketplaceMenuCategoryNav
        ...
        :active-category-id="activeCatId"
        :search-query="mktSearchQuery"
        :is-search-active="isMktSearchActive"
        :available-allergens="availableAllergens"
        :selected-allergens="selectedAllergenFilter"
        :allergen-hidden-count="allergenHiddenCount"
        @select-category="scrollToCategory"
        @search-input="mktSearchQuery = $event"
        @clear-search="mktSearchQuery = ''"
        @toggle-allergen="toggleAllergenFilter"
      />
