  ...
  <div class="min-h-screen pb-16">
    <div class="ui-page-shell max-w-4xl space-y-5">
      ...
      <Transition name="ui-fade">
        <div
          v-if="activeOrder"
          class="group flex items-center gap-3 rounded-xl border border-[var(--color-secondary)]/30 bg-[var(--color-secondary)]/8 px-4 py-3 transition hover:border-[var(--color-secondary)]/50 hover:bg-[var(--color-secondary)]/12"
        >
          <router-link
            :to="{ name: 'marketplace-order-status', params: { slug: activeOrder.slug, orderNumber: activeOrder.number } }"
            class="flex min-w-0 flex-1 items-center gap-3 rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-secondary)]/40"
          ...
          <button
            type="button"
            class="shrink-0 rounded-full p-1 text-slate-500 transition hover:text-slate-300 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-500"
            :aria-label="t('common.dismiss')"
            @click="activeOrderDismissed = true"
          >
