<template>
  <button
    class="group ui-content-auto ui-surface-lift ui-press ui-reveal w-full overflow-hidden rounded-3xl border border-slate-700/60 bg-gradient-to-br from-slate-900/90 via-slate-950 to-slate-900/85 text-left shadow-lg shadow-black/40 transition-all duration-300 hover:-translate-y-0.5 hover:border-[var(--color-secondary)]/70 hover:shadow-xl hover:shadow-black/50"
