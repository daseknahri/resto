...
// props are mutated and nothing is emitted — the parent derives every condition
// (deliveryMinGap, restaurant.is_open, auth) and the submit button + placeOrder stay
// in the parent. A fragment (no wrapper root) so the banners keep their place in the
// drawer body's vertical rhythm.
