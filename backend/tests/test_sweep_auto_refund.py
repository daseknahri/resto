...
class RefundAndCancelHelperTests(SimpleTestCase):
    ...
    def test_pending_order_is_cancelled_and_fully_reversed(
        self, refund_m, loyalty_m, restock_m, broadcast_m, cancel_job_m, dj_m
    ):
...
class AutoRefundSweepPassTests(SimpleTestCase):
    def _run(self, *, candidate, locked_job, deadline=30, order="present"):
        ...
        Returns (refunded_count, refund_helper_mock, alert_owner_mock).
        """
