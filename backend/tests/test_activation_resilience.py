...
class IssueActivationResilienceTests(SimpleTestCase):
    ...
    @patch("sales.services.build_activation_url", return_value="https://demo.menu.ibnbatoutaweb.com/activate?token=abc")
    @patch("sales.services.build_public_menu_url", return_value="https://demo.menu.ibnbatoutaweb.com/menu")
    @patch("sales.services.build_tenant_frontend_url", return_value="https://demo.menu.ibnbatoutaweb.com")
    @patch("sales.services.build_signin_url", return_value="https://demo.menu.ibnbatoutaweb.com/signin")
    @patch("sales.services.build_onboarding_url", return_value="https://demo.menu.ibnbatoutaweb.com/owner/onboarding")
    @patch("sales.services.build_workspace_url", return_value="https://demo.menu.ibnbatoutaweb.com/owner")
    @patch("sales.services.build_admin_url", return_value="https://demo.menu.ibnbatoutaweb.com/admin/")
    ...
    def test_issue_activation_does_not_raise_when_email_fails(
        ...
        self.assertEqual(result[1], "https://demo.menu.ibnbatoutaweb.com/admin/")
        self.assertEqual(result[2], "https://demo.menu.ibnbatoutaweb.com/owner")
        self.assertEqual(result[3], "https://demo.menu.ibnbatoutaweb.com/signin")
        self.assertEqual(result[4], "https://demo.menu.ibnbatoutaweb.com")
        self.assertEqual(result[5], "https://demo.menu.ibnbatoutaweb.com/activate?token=abc")
