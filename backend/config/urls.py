...
urlpatterns = [
    *shared_api_urlpatterns,
    ...
    path("api/reorder-resolve/", ReorderResolveView.as_view(), name="reorder-resolve"),
    ...
    path("api/staff/orders/<int:order_id>/items/<int:item_id>/comp/", StaffCompOrderItemView.as_view(), name="staff-order-item-comp"),
    ...
    path("api/staff/orders/<int:order_id>/seat-split/", StaffSeatSplitView.as_view(), name="staff-order-seat-split"),
    ...
    path("api/staff/clock-in/", StaffClockInView.as_view(), name="staff-clock-in"),
    path("api/staff/clock-out/", StaffClockOutView.as_view(), name="staff-clock-out"),
    path("api/staff/my-shift/", StaffMyShiftView.as_view(), name="staff-my-shift"),
    ...
    path("api/owner/dishes/mark-all-unavailable/", DishBulkMarkUnavailableView.as_view(), name="owner-dishes-mark-all-unavailable"),
    ...
    path("api/owner/repeat-analytics/", OwnerRepeatAnalyticsView.as_view(), name="owner-repeat-analytics"),
    ...
    path("api/owner/ingredients/", OwnerIngredientListCreateView.as_view(), name="owner-ingredients"),
    path("api/owner/ingredients/low-stock/", OwnerIngredientLowStockView.as_view(), name="owner-ingredients-low-stock"),
    path("api/owner/ingredients/<int:pk>/", OwnerIngredientDetailView.as_view(), name="owner-ingredient-detail"),
    path("api/owner/ingredients/<int:pk>/adjust/", OwnerIngredientAdjustView.as_view(), name="owner-ingredient-adjust"),
    path("api/owner/dishes/<int:dish_id>/recipe/", OwnerDishRecipeView.as_view(), name="owner-dish-recipe"),
    path("api/owner/recipe-lines/<int:pk>/", OwnerRecipeLineDetailView.as_view(), name="owner-recipe-line-detail"),
    ...
    # Cash drawer
    path("api/owner/drawer/current/", DrawerCurrentView.as_view(), name="owner-drawer-current"),
    path("api/owner/drawer/open/", DrawerOpenView.as_view(), name="owner-drawer-open"),
    path("api/owner/drawer/transaction/", DrawerTransactionView.as_view(), name="owner-drawer-transaction"),
    path("api/owner/drawer/close/", DrawerCloseView.as_view(), name="owner-drawer-close"),
    path("api/owner/drawer/history/", DrawerHistoryView.as_view(), name="owner-drawer-history"),
