...
shared_api_urlpatterns = [
    ...
    path("api/customer/services/", CustomerServicesView.as_view(), name="customer-services"),
    path("api/customer/active/", CustomerActiveItemsView.as_view(), name="customer-active-items"),
    path("api/customer/notifications/", CustomerNotificationsView.as_view(), name="customer-notifications"),
    path("api/customer/notifications/mark-read/", CustomerNotificationsMarkReadView.as_view(), name="customer-notifications-mark-read"),
    path("api/customer/service-profiles/", CustomerServiceProfilesView.as_view(), name="customer-service-profiles"),
    ...
    path("api/customer/orders/claim/", CustomerClaimOrderView.as_view(), name="customer-orders-claim"),
    path("api/customer/businesses/", CustomerBusinessesView.as_view(), name="customer-businesses"),
    path("api/customer/businesses/follow/", CustomerBusinessFollowView.as_view(), name="customer-businesses-follow"),
    ...
    path("api/driver/cashout/history/", DriverCashoutHistoryView.as_view(), name="driver-cashout-history"),
    ...
    path("api/rides/<int:ride_id>/tip/", RideTipView.as_view(), name="ride-tip"),
