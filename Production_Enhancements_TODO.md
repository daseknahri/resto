...
- [ ] lead -> provision -> activation -> onboarding -> publish
- [ ] cross-subdomain auth/csrf behavior
...
- [ ] Add feature-flag admin controls per plan.
...
- [ ] Configure static/media serving and caching.
- [ ] Add environment separation (dev/stage/prod) and secrets management.
