...
| B3 | **Ingredient/recipe inventory + food-cost %.** Phase 1 ✅ — `Dish.cost_price` field (migration 0063) + food-cost section on Z-report (Subquery aggregation) + labor section on Z-report frontend. Phase 2 (full Ingredient/BOM + depletion + variance) unstarted. | XL (phase it) | Restaurant lens |
