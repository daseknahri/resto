...
`main` is green and deployable (all CI jobs pass, on **Django 5.2.17 LTS**). Three campaigns shipped since #168: the 2026-08 daily-use / reliability / product-content / flow pass (**#169–#192**), the 2026-08-05 super-app hardening + calibration campaign (**#199–#204**), and the 2026-08-12 **operational-gaps closure + big-test QA sweep** (**#217–#220**) — which closed the last flagged UX gaps and settled four money/product decisions. **Speed and navigation were already done** (the `PERF_HOSTING_AUDIT.md` backlog is implemented; the IA is mature) — do **not** re-audit them. Everything shippable without an owner decision or external prerequisite is done.
